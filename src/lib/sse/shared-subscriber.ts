...
type GlobalSharedSubscriber = typeof globalThis & {
  __wacooSharedSubscriber?: SharedSubscriber
}

const globalForSharedSubscriber = globalThis as GlobalSharedSubscriber

export function getSharedSubscriber() {
  if (!globalForSharedSubscriber.__wacooSharedSubscriber) {
    globalForSharedSubscriber.__wacooSharedSubscriber = new SharedSubscriber()
  }
  return globalForSharedSubscriber.__wacooSharedSubscriber
}
