...
const messages = {
  assetModal: {
    character: {
      ...
      uploadCharacterImages: '上传角色图片',
      uploadReference: '上传参考图',
      uploadThreeView: '上传三视图',
      pasteHint: 'Ctrl+V 粘贴',
      ...
      maxThreeViewImages: '最多上传 3 张三视图',
      selectedThreeViewCount: '已选择 {count}/3 张三视图',
      description: '角色描述',
      ...
      changeReason: '形象变化原因',
      changeReasonPlaceholder: '例如：战斗后受伤',
