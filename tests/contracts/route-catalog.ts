...
const ROUTE_FILES = [
  ...
  'src/app/api/comfyui/history/[promptId]/route.ts',
  'src/app/api/comfyui/prompt/route.ts',
  'src/app/api/comfyui/upload/route.ts',
  ...
  'src/app/api/novel-promotion/[projectId]/reference-assets/[assetId]/route.ts',
  'src/app/api/novel-promotion/[projectId]/reference-assets/route.ts',
